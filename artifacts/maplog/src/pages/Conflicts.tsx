...
import { ArrowLeft, Copy, CheckCircle2, AlertTriangle, Trash2 } from 'lucide-react';
import { toast } from 'sonner';
import { motion, AnimatePresence } from 'framer-motion';

/**
 * Conflict resolution — copies pulled out of the collection during import
 * because they broke tag rules wait here. The user keeps one copy (restores
 * it) or discards all. Will move inside Edit Mode later.
 */
